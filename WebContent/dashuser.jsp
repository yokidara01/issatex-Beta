        ...
        <div class="media user-media bg-dark dker">
          ...
          <div class="user-wrapper bg-dark">
            <a class="user-link" href="">
              <img class="media-object img-thumbnail user-img" alt="User Picture" src="<%=request.getContextPath()%>/Dashboard/dist/assets/img/user.gif">
              <span class="label label-danger user-label">16</span> 
            </a> 
            <div class="media-body">
              <h5 class="media-heading">Archie</h5>
              <ul class="list-unstyled user-info">
                <li> <a href=""><%=c.getNom() %></a>  </li>
                <li>Last Access :
                  <br>
                  <small>
        ...
        <ul id="menu" class="bg-blue dker">
          ...
          <li class="">
            <a href="javascript:;">
              ...
              <span class="link-title">Ordres</span> 
              <span class="fa arrow"></span> 
            </a> 
            <ul>
             <li>
                <a href="addarticle.jsp">
                  <i class="fa fa-angle-right"></i>&nbsp; Creer un article </a> 
              </li>
              <li>
                <a href="addarticle.jsp">
                  <i class="fa fa-angle-right"></i>&nbsp; Creer un ordre de fabrication </a> 
              </li>
              <li>
                <a href="modifArticle.jsp">
                  <i class="fa fa-angle-right"></i>Creer un ordre de fabrication urgent </a> 
              </li>
              <li>
                <a href="deleteArticle.jsp">
                  <i class="fa fa-angle-right"></i>G�rer les ordres</a> 
              </li>
