		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="active"><a href="deleteArticle.jsp"><span>supprimer</span></a>
					</li>
					<li class="active"><a href="validerArticle.jsp"><span>valider</span></a>
					</li>
					...
					<li class="active"><a href="planifier.jsp"><span>Planifier
								pour cette semaine</span></a></li>
					<li class="header">Rendement</li>
					<li class="active"><a href="rendementj.jsp"><span>Rendement
								Journalier</span></a></li>
					<li class="active"><a href="rendementh.jsp"><span>Rendement
								Hebdomadaire</span></a></li>
				</ul>
				</li>
				</ul>
				<!-- /.sidebar-menu -->
...
{	
	...
	<script src="planningjs.js"></script>
</body>
</html>