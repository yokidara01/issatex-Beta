...
<html class="no-js">
  ...
  <body class="  ">
   ...
   <table border="3">
   			...
   			ArrayList<Article> ListArticle = adao.GetAllArticle(); 
   			...
   			<tr>
   				...
   				<td align="center" id="checkEtat"><%=ListArticle.get(i).getTemp() %></td>
   			</tr><%} %>
   			</table>
	...
	<h3>Ajouter un article </h3>
		...
		<form action="../../AddArticle" method="post">
			...
			Désination : <input type="text" name="desArticle" id="libart"> <br> <br> 
			Temps Unitaire : <input type="text" name="tempsUni" id="tu"><br> <br> 
			Prix Moyen : <input type="text" name="PUmoy" id="pm"> <br> <br>
