...
<html>
  ...
  <body class="skin-blue">
   ...
   <center>
   		...
   		<p style="color: green"><%out.print("Modifier avec succés"); %></p>
   		<%} %>
   		...
   		<table border="3">
   			...
   			<tr>
   				...
   				<td align="center"><a href="../UpdateArt?RefArt=<%=ListArticle.get(i).getRefArt()%>">
   				<input type="button" name="updateart" value="Modifier"></a></td>
