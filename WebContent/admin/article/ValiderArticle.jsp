...
<html>
  ...
  <body class="skin-blue">
   ...
   <center>
   		...
   		<% if(request.getAttribute("valider") != null){ %>
   		
   		<p style="color: green"><%out.print("l'article est valider"); %></p>
   		<%} %>
   		<% if(request.getAttribute("déjavalider") != null) {%>
   		<p style="color: red"><%out.print("l'article est déja validé"); %></p>
   		<%} %>
   		...
   		<table border="3">
   			...
   			<tr>
   				...
   				<td align="center"><a href="../DevaliderArt?RefArt=<%=ListArticle.get(i).getRefArt()%>&Etat=<%=ListArticle.get(i).getTemp()%>">
   				<img id="validation" alt="Valider l'article" src="img/dévaliderIcone.png" width="20" height="20" border="none"/></a></td><%} 
   				else if(ListArticle.get(i).getTemp() == 0) {%>
   				<td align="center" id="nonvalide"><%=ListArticle.get(i).getTemp() %></td>
   				<td align="center"><a href="../ValiderArt?RefArt=<%=ListArticle.get(i).getRefArt()%>&Etat=<%=ListArticle.get(i).getTemp()%>">
   				<img id="validation" alt="Valider l'article" src="img/validerIcone.png" width="20" height="20" border="none"/></a></td><%} %>
