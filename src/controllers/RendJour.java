...
/**
 * Servlet implementation class RendJour
 */
public class RendJour extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String req= "select * from presence where date='"+date+"'" ;
		...
		//System.out.println((total*100)/(8*i)+"%");
		if ((total==0) || (i==0))
		{
